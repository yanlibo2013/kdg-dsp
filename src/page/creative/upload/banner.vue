            ...
            <el-col :span="24">
                ...
                <div class="update-local-file">
                    ...
                    <div class="update-item-row browse-row">
                        ...
                        <el-input class="upload-control" id="uploadLocalFile" :class="{'upload-input':isUpload}" placeholder="请上传素材文件" :readonly="true" v-model="filename">
                        <i slot="suffix" class="el-icon-close" @click="clearUpload"></i>
                        </el-input>
                        <el-button size="small" type="upload" @click="selectfile">浏览</el-button>
                        <input type="file" name="pic" accept="image/gif, image/png, image/jpeg" id="file" @change="upload" style="display:none" v-if="iconFileShow" />
                    </div>
                </div>
</template>
                        </el-tab-pane>
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                if (this.uploadType == "1") {
                    ...
                    // fileData.append("creative_name", this.form.creative_name);
        ...
        mounted() {
            ...
            // console.log(this.$refs.containerWrap);
                ...
                // let containerHeight = document.getElementById("creative-wrap");
