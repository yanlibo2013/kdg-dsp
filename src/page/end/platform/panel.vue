    ...
    <div>
        <div class="account-search-wrap left">
            <div class="el-input el-input--prefix">
                <input autocomplete="off" placeholder="输入尺寸..." type="text" prefixicon="el-icon-search" clearable="true" :class="setShowPanel?'el-input__inner':'el-input__inner adjust-border-radius'" @keyup="searchDataBykeyword(keyword)" v-model="keyword" @focus="showPanel"
                />
                ...
                <el-checkbox class="add-checkbox" v-model="checked" v-show="isAddItem">
                    <template>
                                    ...
                                    <el-checkbox-group v-model="checkList" @change="handleCheckedCitiesChange">
                                        <ul v-for="item in leftSizeList" :key="item">
                            ...
                            <div class="account-list" v-show="setShowPanel">
                                ...
                                <div class="account-clear-bd innerbox">
                                    <ul v-for="item in checkList" :key="item">
                                        <li class="search-item">
        ...
        methods: {
            ...
            addItem() {
                if (this.verification()) {
                    ...
                    this.isAddItem = false;
                    end.addSizeItem({width:this.form.width,height:this.form.height}).then(res => {
                        if (res.data.code == 0) {
                            this.$message({
                                message: '操作成功',
                                type: 'success'
