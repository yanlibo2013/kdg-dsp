...
<template>
    ...
    <div class="ad-create">
            ...
            <el-form ref="form" :model="form" :rules="adformrules" class="adform">
                <el-col :span="24">
                    ...
                    <div class="base-bd border-bottom-2 relative">
                        ...
                        <div class="create-row">
                            <label for="" class="data-item fl" style="padding-left:10px"><i class="item-needed">*</i>
                            广告位id：</label>
                            <div class="item2 relative" style="margin-bottom:13px">
                                

                                <el-checkbox 
                                @change="changeAdError"
                                class="" 
                                v-model="form.Andchecked">
                            ...
                            <div  class="relative" style="margin-bottom:0px">
                                ...
                                <el-checkbox 
                                @change="changeAdError"
                                style="margin-left:-5px" v-model="form.ioschecked">
                        ...
                        <div class="create-row" style="margin-top:-9px">
                                 <el-form-item label="日均PV:"  style="padding-left:25px;display:inline-block" prop="pv"
                                 >
                                    <el-input 
                        ...
                        <div class="create-row" style="height: 38px;line-height: 38px">
                             <el-form-item class="data-item" style="padding-left:18px" label="结算类型:" prop="settlement_type">
                        ...
                        <!-- 结算价格： start -->
                        <div class="create-row" style="padding-left:16px">
                            <label for="" class="data-item left" ><i class="item-needed">*</i>结算价格：</label>
                                   ...
                                   <!--  <el-input 
                                    v-model="form.settlement_price"
                                      ></el-input> -->
                                       ...
                                       <el-form-item style="margin-left:-106px" prop="settlement_price">
                                          <el-input v-model="form.settlement_price"></el-input>
                                       </el-form-item>
                        ...
                        <!-- 结算价格： end -->
                           ...
                           <!-- 广告样式： start -->
                        <div class="create-row" style="margin-top:16px;padding-left:16px">
                            <label for="" class="data-item left"><i class="item-needed">*</i>广告样式：</label>
                            <div 
                            class="unit-setting ad-style"
                            ...
                            >
                               ...
                               'noMr': index === 4}"
                                @click="tabAdStyle($event,index)"
                                v-for='item,index in adStyle'>
                                <em>{{item}}</em>
                              </span>   
                               
                            </div>

                <div class="tabcon" style="margin-left:91px">
                    
                    <div 
                      :class="isEdit || activeEdit ? 'saveIcon' : 'addIcon' "
                      @click="addStyleAction(selectIndex)">
                ...
                <!-- 图片 黑框 start  isEdit -->
                    <div class="adstylelist" :class="adstylelen >= 2 ? 'mt-100' : ''">
                        ...
                        <div 
                        class="imgStyle"
                        v-for="item in this.style_details.imgStyle"
                        >
                           <div 
                           style="float:left;width: 222px;height:155px"
                           >
                               <img src="../../../style/image/meadia/img1.jpg" alt="">
                           </div>
                           <div class="rightBtn">
                              <div class="money iconGroup" 
                              @click="Tomoney(item)"
                              ></div>
                              <div class="edit iconGroup"
                              @click="Toedit(item)"
                              ></div>
                              <div class="del iconGroup"
                             @click="Todel(item)"
                              ></div>
                           </div>
                              <span class="tiptxt1">
                    ...
                    <!-- 图文 黑框 start-->
                        <div 
                        class="imgStyle imgStyle2"
                        v-for="item in this.style_details.imgText"
                        >
                           <div class="wrap">   
                            <div>
                                <span v-if="item.logo" class="con1">
                                LOGO
                               </span>
                        ...
                        <div 
                        class="imgStyle imgStyle2"
                        v-for="item in this.style_details.imgGroup"
                        >
                           <div class="wrap">   
                            <div>
                                <span class="con1" v-if="item.logo">
                                    LOGO
                               </span>
                               <span class="con2"  v-if="item.Title">
                                标题
                               </span>
                            </div>
                               ...
                               style="position: absolute;top: 61px;">
                                ...
                                src="../../../style/image/meadia/img2.jpg"><img 
                                class="con9" 
                                src="../../../style/image/meadia/img2.jpg"><img 
                                class="con9" 
                                src="../../../style/image/meadia/img2.jpg">
                        ...
                        <div 
                        class="imgStyle imgStyle2"
                        v-for="item in this.style_details.shortvideo"
                        >
                           <div class="wrap">   
                            <div>
                                <span v-if="item.logo" class="con1">
                               ...
                               <span v-if="item.Title" class="con2">
                                标题
                               </span>
                            </div>
                               ...
                               <div style="margin-top:10px">
                                ...
                                style="margin-left:0px" 
                                src="../../../style/image/meadia/img2.jpg">
                                <span class="con8" v-if="item.Video">
                        ...
                        <div 
                        class="imgStyle imgStyle2"
                        v-for="item in this.style_details.video"
                        >
                           <div class="wrap">
                              <div 
                            ...
                            line-height: 162px;text-align: center">
                                <img 
                                class="con7" 
                                src="../../../style/image/meadia/video.jpg">
                    ...
                    <div class="tabItem" :style="{'display':selectIndex == 0 ? 'block':'none'}">
                        <div style="margin-top:10px ">
                             <el-checkbox 
                             :disabled="isEdit"
                             v-model="form.imgStyle.img">图片：</el-checkbox>
                             <el-input 
                             v-model="form.imgStyle.W"
                             style="width:80px"
                             placeholder="宽"
                             ></el-input>
                             <span class="X-style">x</span>
                              <el-input 
                               v-model="form.imgStyle.H"
                               style="width:80px"
                              placeholder="高"></el-input>
                               <el-select
                               style="min-width:66px"
                               multiple
                                v-model="form.imgStyle.imagetype" placeholder="请选择格式">
                                    <el-option
                                      v-for="item in form.imgStyle.imgoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                        ...
                        <div class="mt15" style="margin-bottom:12px;display:none">
                              <el-checkbox :disabled="isEdit" v-model="form.imgStyle.logo">是否需要logo</el-checkbox>
                        </div>      
                    </div>
                  <!--图片  end-->
                  ...
                  <!--图文  start-->
                    ...
                    :style="{'display':selectIndex == 1 ? 'block':'none'}">
                        <div>
                             ...
                             <span class="X-style">x</span>
                              ...
                              placeholder="高"></el-input>
                               ...
                               multiple
                                v-model="form.imgText.imagetype" placeholder="请选择格式">
                                    <el-option
                                      v-for="item in form.imgText.imgoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                        ...
                        <div class="mt10">
                             <el-checkbox :disabled="isEdit" v-model="form.imgText.Title">标题：</el-checkbox>
                             <el-input 
                             v-model="form.imgText.title"
                             style="width:180px"
                             @input="changeState($event,'title','imgText')"
                             placeholder="请输入字数限制"></el-input>
                        </div>

                        <div class="mt10">
                             <el-checkbox :disabled="isEdit" v-model="form.imgText.Desc">描述：</el-checkbox>
                             <el-input 
                             @input="changeState($event,'desc','imgText')"
                             v-model="form.imgText.desc"
                             style="width:180px"
                             placeholder="请输入字数限制"></el-input>
                        </div>  
                    ...
                    <!--图文  end--> 
                        ...
                        <div class="tabItem tabItem2" :style="{'display':selectIndex == 2 ? 'block':'none'}">
                           <div>
                             ...
                             <el-input 
                             v-model="form.imgGroup.W"
                             style="width:140px"
                             placeholder="宽"></el-input>
                              <span class="X-style">x</span>
                              <el-input 
                               v-model="form.imgGroup.H"
                               style="width:140px"
                              placeholder="高"></el-input>
                        ...
                        <div class="mt10">
                            <el-select
                             multiple
                               style="width:140px;margin-left:68px"
                                v-model="form.imgGroup.imagetype" placeholder="请选择格式">
                                    <el-option
                                      v-for="item in form.imgGroup.imgoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                                  ...
                                  v-model="form.imgGroup.imagenumber" placeholder="请选择个数">
                                    <el-option
                                      v-for="item in form.imgGroup.imgoptionsnum"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                        ...
                        <div class="mt10">
                             <el-checkbox :disabled="isEdit" v-model="form.imgGroup.Title">标题：</el-checkbox>
                             <el-input 
                             v-model="form.imgGroup.title"
                             @input="changeState($event,'title','imgGroup')"
                             style="width:180px"
                             placeholder="请输入字数限制"></el-input>
                        </div>
                        <div class="mt10">
                             ...
                             <el-input 
                             v-model="form.imgGroup.desc"
                             @input="changeState($event,'desc','imgGroup')"
                             style="width:180px"
                             placeholder="请输入字数限制"></el-input>
                        </div>
                        <div class="mt15">
                    ...
                    <!--短视频  start-->
                        ...
                        <div>
                             ...
                             <el-input 
                             v-model="form.shortvideo.W"
                             style="width:80px"
                             placeholder="宽"></el-input>
                             <span class="X-style">x</span>
                              <el-input 
                               v-model="form.shortvideo.H"
                               style="width:80px"
                              placeholder="高"></el-input>
                               <el-select
                            
                                multiple
                                v-model="form.shortvideo.imagetype" placeholder="请选择格式">
                                    <el-option
                                      v-for="item in form.shortvideo.imgoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                           ...
                           <div class="mt10">
                             ...
                             <el-input 
                             v-model="form.shortvideo.videowidth"
                             style="width:140px"
                             placeholder="宽"></el-input>
                             <span class="X-style">x</span>
                              <el-input 
                               v-model="form.shortvideo.videoheight"
                               style="width:140px"
                              placeholder="高"></el-input>
                        ...
                        <div class="mt10 inner3">
                            <el-select
                              multiple
                               style="width:140px;margin-left:68px"
                                v-model="form.shortvideo.videotype" placeholder="请选择格式">
                                    <el-option
                                      v-for="item in form.shortvideo.videooptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                                  ...
                                  <el-select
                               style="width:140px;margin-left:25px"
                                v-model="form.shortvideo.videotime" placeholder="请选择时长">
                                    <el-option
                                      v-for="item in form.shortvideo.timeoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                        ...
                        <div class="mt10">
                             <el-checkbox :disabled="isEdit" v-model="form.shortvideo.Title">标题：</el-checkbox>
                             <el-input 
                             v-model="form.shortvideo.title"
                             @input="changeState($event,'title','shortvideo')"
                             style="width:180px"
                             placeholder="请输入字数限制"></el-input>
                        </div>
                        <div class="mt10">
                             ...
                             <el-input 
                             v-model="form.shortvideo.desc"
                             @input="changeState($event,'desc','shortvideo')"
                             style="width:180px"
                             placeholder="请输入字数限制"></el-input>
                        </div>
                        <div class="mt15">
                    ...
                    <!--视频  start-->
                        <div class="tabItem tabItem3" :style="{'display':selectIndex == 4 ? 'block':'none'}">
                           ...
                           <div class="mt10">
                             ...
                             <el-input 
                             v-model="form.video.videowidth"
                             style="width:140px"
                             placeholder="宽"></el-input>
                             <span class="X-style">x</span>
                              <el-input 
                               v-model="form.video.videoheight"
                               style="width:140px"
                              placeholder="高"></el-input>
                        ...
                        <div class="mt10 inner3">
                            <el-select   
                              multiple
                               style="width:140px;margin-left:68px"
                                v-model="form.video.videotype" placeholder="请选择格式">
                                    <el-option

                                      v-for="item in form.video.videooptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                               ...
                               style="width:140px;margin-left:25px"
                                v-model="form.video.videotime" placeholder="请选择时长">
                                    <el-option
                                      v-for="item in form.video.timeoptions"
                                      :key="item.value"
                                      :label="item.label"
                                      :value="item.value">
                                    </el-option>
                    ...
                    <!--视频  end-->
                        ...
                        <!-- 状态 start -->
                        <div class="create-row" style="height:38px;line-height: 38px;padding-left:43px">
                        ...
                        <!-- 备注 -->
                        <div class="create-row" style="padding-left:43px">
                            <label for="" class="data-item " style="float:left">备注：</label>
                            <el-input 
                            style="float: left;margin-left:-41px;width:30%"
                             type="textarea"
                             :rows="2"
        ...
        <pricedialog 
         ...
         :title="dialogtitle"
         :type="type"
         v-on:closeDialog="closeDialogFn"
         v-on:submitDialog="submitDialogFn"
      ...
      components:{
        ...
        data: function() {
            ...
            return {
                adformrules:{
                      pv: [
                        { required: true, message: 'pv不能为空', trigger: 'blur' },
                    ...
                    settlement_type: [
                      ...
                      settlement_price : [
                          { required: true, message: '结算价格不能为空', trigger: 'blur' },
        ...
        mounted() {
            ...
            if (id) {
                that.addStyle = true;
                meadia.mediaAdlistNew_mediaAdlitDefault({
                    id: id
                }).then(res => {
                    if (res.data.code == 0) {
                        ...
                        //that.form.ad_pid = data.ad_pid || "";

                        that.form.ad_pid = JSON.parse(data.ad_pid) || [];//广告位id数据

                        that.form.pv = data.pv || "";
                        that.form.settlement_type = data.settlement_type.toString() || "";
                        that.form.Andchecked = data.ad_type == 1 ? true : false;
                        that.form.ioschecked = data.ad_type == 2 ? true : false;
                        ...
                        that.form.update_time = data.update_time || "";
                        console.log(JSON.parse(data.style_details));
                        let style_details_ary = JSON.parse(data.style_details);
                        that.editStyleDetails = JSON.parse(data.style_details);
                        for(let i=0;i<style_details_ary.length;i++){
                            let type = style_details_ary[i].type;
                            if(type == 'image'){
                                 getList1(style_details_ary[i]);
                            }
                            if(type == 'imagetext'){
                                console.log(style_details_ary[i]);
                        ...
                        function getList1(obj){
                            that.form.imgStyle.float_x = obj.float_x;
                            that.style_details.imgStyle.push({
                                'H':obj.H,//高度
                                'W':obj.W,//宽度
                                'float_x':obj.float_x || 0,//浮动系数
                                'imagetype':obj.imagetype,
                                'type':'image',//类型
                                'img':obj.image,
                                'video':obj.video || false,
                                'logo':obj.logo,
                                 "imagenumber":obj.imagenumber || 1,
                                'id':obj.id
                            })
                        }

                        function getList2(obj){
                            that.form.imgText.float_x = obj.float_x;
                            console.log(that.form.imgText.float_x);
                        ...
                        function getList3(obj){
                            that.form.imgGroup.float_x = obj.float_x;                           
                        ...
                        function getList4(obj){
                            that.form.shortvideo.float_x = obj.float_x;
                        ...
                        function getList5(obj){
                            that.form.video.float_x =     obj.float_x;
          ...
          // },
            ...
            Toedit(item){//样式的编辑
             ...
             if(item.type == "image"){
                    ...
                    that.form.imgStyle.img =   _ary[_index].img;
                    ...
                    that.form.imgStyle.video =  _ary[_index].video;
                    that.form.imgStyle.logo =  _ary[_index].logo;
                    that.form.imgStyle.float_x =  _ary[_index].float_x || 0;
               ...
               if(item.type == "imagetext"){
                    that.selectIndex = 1;
                     ...
                     console.log(_index);
                      ...
                      that.form.imgText.desc =   _ary[_index].desc;
                      that.form.imgText.title =  _ary[_index].title;
                      that.form.imgText.logo =   _ary[_index].logo;
                      that.form.imgText.type =   _ary[_index].type;
                      that.form.imgText.float_x =  _ary[_index].float_x || 0;
               }
                ...
                if(item.type == "imagegroup"){
                        ...
                        that.form.imgGroup.desc =        _ary[_index].desc;
                        that.form.imgGroup.title =       _ary[_index].title;
                        that.form.imgGroup.logo =        _ary[_index].logo;
                        that.form.imgGroup.img =         _ary[_index].img;
                        if(typeof _ary[_index].imagetype == "string"){
                            that.form.imgGroup.imagetype = _ary[_index].imagetype.split(",");
                        }else{
                            that.form.imgGroup.imagetype = _ary[_index].imagetype
                        }
                        that.form.imgGroup.float_x =  _ary[_index].float_x || 0;
               ...
               if(item.type == "shortvideo"){
                        ...
                        let _index = _ary.indexOf(item);
                          ...
                          that.form.shortvideo.Title =     _ary[_index].Title;
                          that.form.shortvideo.Desc =      _ary[_index].Desc;
                          that.form.shortvideo.Video =     _ary[_index].Video;
                          that.form.shortvideo.logo =      _ary[_index].logo;
                          that.form.shortvideo.img =       _ary[_index].img;
                          if(typeof _ary[_index].imagetype == "string"){
                          ...
                          if(typeof _ary[_index].videotype == "string"){
                           ...
                           that.form.shortvideo.float_x =  _ary[_index].float_x || 0;
                        
               }
               if(item.type == "longvideo"){
                  that.selectIndex = 4;
                   ...
                   let _index = _ary.indexOf(item);
                    ...
                    that.form.video.Video =       _ary[_index].Video;  
                    ...
                    if(typeof _ary[_index].videotype == "string"){
                     ...
                     that.form.video.float_x =  _ary[_index].float_x || 0;
                             ...
                             for (var i = that.style_details.imgStyle.length - 1; i >= 0; i--) {
                                ...
                                //item.id = item.id == 0 ? 0 : 1;
                                 if(item.id == that.selectID){
                                    ...
                                    item.float_x = item.float_x ? item.float_x : (that.form.imgStyle.float_x ||0);
                      ...
                      that.activeEdit = false
                        ...
                        this.isAddAction(
                           this.style_details.imgStyle,
                           {
                            ...
                            'float_x': 0,
                            //'float_x':this.form.imgStyle.float_x || 0,
                           ...
                           this.style_details.imgText.forEach((item,index)=>{
                              //item.id = item.id == 0 ? 0 : 1;
                                  if(item.id == that.selectID){
                                      ...
                                      item.float_x = item.float_x ? item.float_x : (that.form.imgText.float_x ||0);
                        ...
                        this.isAddAction(
                           this.style_details.imgText,
                           {
                            ...
                            'imagetype':that.form.imgText.imagetype.length >1 ? that.form.imgText.imagetype.join(","): that.form.imgText.imagetype.toString(),
                             ...
                             'float_x': 0,
                             // 'float_x':that.form.imgText.float_x || 0,
                         ...
                         this.style_details.imgGroup.forEach((item,index)=>{
                            //item.id = item.id == 0 ? 0 : 1;
                              if(item.id == that.selectID){
                                  ...
                                  item.float_x = item.float_x ? item.float_x : (that.form.imgGroup.float_x ||0);
                              }
                            })
                        ...
                        this.isAddAction(
                           this.style_details.imgGroup,
                           {
                            ...
                            'imagetype':that.form.imgGroup.imagetype.length>1 ? that.form.imgGroup.imagetype.join(",") : that.form.imgGroup.imagetype.toString(),
                             ...
                             // "float_x":this.form.imgGroup.float_x ||0,
                             "float_x":0,
                    ...
                    if(that.selectID > -1){
                         ...
                         this.style_details.shortvideo.forEach((item,index)=>{
                          if(item.id == that.selectID){
                            ...
                            item.float_x = item.float_x ? item.float_x : (that.form.shortvideo.float_x ||0);
                          }
                       })
                        ...
                        this.isAddAction(
                           this.style_details.shortvideo,
                           {
                            ...
                            'videotime':this.form.shortvideo.videotime,
                             ...
                             // "float_x":this.form.shortvideo.float_x ||0,
                             "float_x":0,
                     ...
                     if(that.selectID > -1){
                         ...
                         this.style_details.video.forEach((item,index)=>{
                          ...
                          if(item.id == that.selectID){
                              ...
                              item.float_x = item.float_x ? item.float_x : (that.form.video.float_x ||0);
                 ...
                 if (valid && !that.isAdError) {
                  ...
                  let resultAry = [];
                    ...
                    if(that.style_details.imgGroup.length > 0){
                         for(let m=0;m<that.style_details.imgGroup.length;m++){
                            ...
                            resultAry.push({
                                    ...
                                    "H":item2.H,
                                    "imagetype":str2,//图片类型
                                    "imagenumber":item2.imagenumber ||3,
                                    "title":item2.title,
                                    "desc":item2.desc,
                                    "logo":item2.logo,
                                    "float_x":item2.float_x || 0,//浮动系数
                                    "type":"imagegroup",
                                    "Title":item2.Title,
                                    "Desc":item2.Desc,
                                    "id":item2.id
                       ...
                       for(let j=0;j<that.style_details.shortvideo.length;j++){
                           let item3 = that.style_details.shortvideo[j];
                            ...
                            resultAry.push({
                                    ...
                                    "video":item3.Video,
                                    "videotype":videoStr3,
                                    "videowidth":item3.videowidth,
                                    "videoheight":item3.videoheight,
                                    "videotime":item3.videotime,
                                    "title":item3.title,
                                    "desc":item3.desc,
                                    "logo":item3.logo,
                                    "float_x":item3.float_x || 0,//浮动系数
                                    "type":"shortvideo",
                                    "Title":item3.Title,
                                    "Desc":item3.Desc,
                                    "id":item3.id 
                    ...
                    if(that.style_details.video.length > 0){
                        for(let k=0;k<that.style_details.video.length;k++){
                           ...
                           let videoStr4 = item4.videotype;
                            resultAry.push({
                                    "video":item4.Video,
                                    "videowidth":item4.videowidth,
                                    "imagenumber":"1",
                                    "videoheight":item4.videoheight,
                                    "videotime":item4.videotime,
                                    "videotype":videoStr4,
                                    "float_x":item4.float_x || 0,//浮动系数
                                    "type":"longvideo",
                                    "id":item4.id
                            })
                          }
                     ...
                     let fileData = {
                        ...
                        "media_id":that.$route.query.meadiaId || "",//媒体id
                        ...
                        //JSON.stringify
                        "style_details":JSON.stringify(resultAry)
                    };
                    ...
                    if(resultAry.length == 0){
                     ...
                     meadia.mediaAdlistNew_mediaAdlitEditNew(fileData).then(res => {
                        if (res.data.code == 0) {
                            this.$message({
                                // message: res.data.msg,
                                message: "操作成功",
...
<style lang="scss">
    ...
    .X-style{
        display:inline-block;margin:auto 7px;
    }
    @import "../../../style/mixin";
    @import "../../../style/common";
    .ad-create {
        ...
        .create-row {
            ...
            .tabcon{
                   margin-left:102px;margin-top:20px;
                   position: relative;
                   .tabItem{
                    width:418px;
                    background:#fafbfe;
                   ...
                   .adstylelist{
                        ...
                        .imgStyle{
                           ...
                           .tiptxt1{
                            ...
                            .rightBtn{
                                float:right;width:51px;height:155px
                            }
                            
                        }
                        .imgStyle2{
                            .wrap{
                                float:left;width: 225px;height:155px;background:#e6ebf3;padding:10px;
                                position:relative;
                            }
                            .con1{
                                background:#fff;color:#515974;width:45px;height:42px;text-align: center;line-height: 42px;
                                position: absolute;
                                top: 10px;
                                left: 10px;
                                font-size: 12px;
                            ...
                            .con2{
                                 background:#fff;color:#515974;width:149px;height:42px;line-height: 42px;text-align: center;position: absolute;
                                        top: 10px;
                                        right: 10px;
                            }
                            .con3{
